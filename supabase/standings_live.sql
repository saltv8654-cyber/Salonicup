-- ========================================================================
-- Salonicup · LIVE βαθμολογία — η βαθμολογία μετράει ΚΑΙ τους live αγώνες
-- (με το τρέχον σκορ). Τρέξε το ΜΙΑ φορά στο Supabase → SQL Editor.
-- ========================================================================
...
with results as (
  ...
  from matches m
  where m.match_status in ('Played','Forfeit','Live')   -- ← προστέθηκε το Live
